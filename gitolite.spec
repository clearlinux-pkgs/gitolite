...
Source0  : https://github.com/sitaramc/gitolite/archive/v3.6.8.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: gitolite-bin
Requires: gitolite-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1531428821
make  %{?_smp_mflags}

%install
export SOURCE_DATE_EPOCH=1531428821
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/gitolite
cp COPYING %{buildroot}/usr/share/doc/gitolite/COPYING
%make_install
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/gitolite/COPYING
