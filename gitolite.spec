...
Version  : 3.6.9
Release  : 10
URL      : https://github.com/sitaramc/gitolite/archive/v3.6.9.tar.gz
Source0  : https://github.com/sitaramc/gitolite/archive/v3.6.9.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536416960
make  %{?_smp_mflags}
